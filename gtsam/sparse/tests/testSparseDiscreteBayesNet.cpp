...
/*
 * testSparseDiscreteBayesNet.cpp
 *
 *  @date May, 2023
 *  @author Yoonwoo Kim
 */
...
// /* ************************************************************************* */
// TEST(SparseDiscreteBayesNet, bayesNet) {
//   SparseDiscreteBayesNet bayesNet;
//   DiscreteKey Parent(0, 2), Child(1, 2);

//   auto prior = std::make_shared<SparseDiscreteConditional>(Parent % "6/4");
//   CHECK(assert_equal(TableFactor({Parent}, "0.6 0.4"),
//                      (TableFactor)*prior));
//   bayesNet.push_back(prior);

//   auto conditional =
//       std::make_shared<SparseDiscreteConditional>(Child | Parent = "7/3 8/2");
//   EXPECT_LONGS_EQUAL(1, *(conditional->beginFrontals()));
//   TableFactor expected(Child & Parent, "0.7 0.8 0.3 0.2");
//   CHECK(assert_equal(expected, (TableFactor)*conditional));
...
// /* ************************************************************************* */
// TEST(SparseDiscreteBayesNet, Asia) {
//   SparseDiscreteBayesNet asia;
...
//   SparseDiscreteBayesNet::shared_ptr chordal = fg.eliminateSequential(ordering);
//   SparseDiscreteConditional expected2(Bronchitis % "11/9");
...
//   SparseDiscreteBayesNet::shared_ptr chordal2 = fg.eliminateSequential(ordering);
//   EXPECT(assert_equal(expected2, *chordal->back()));
...
//   SETDEBUG("SparseDiscreteConditional::sample", false);
//   auto actualSample = chordal2->sample();
//   EXPECT(assert_equal(expectedSample, actualSample));
// }

// /* ************************************************************************* */
// TEST(SparseDiscreteBayesNet, Sugar) {
//   DiscreteKey T(0, 2), L(1, 2), E(2, 2), C(8, 3), S(7, 2);

//   SparseDiscreteBayesNet bn;
...
// /* ************************************************************************* */
// TEST(SparseDiscreteBayesNet, Dot) {
//   SparseDiscreteBayesNet fragment;
...
// TEST(SparseDiscreteBayesNet, markdown) {
//   SparseDiscreteBayesNet fragment;
//   fragment.add(Asia % "99/1");
//   fragment.add(Smoking | Asia = "8/2 7/3");

//   string expected =
//       "`SparseDiscreteBayesNet` of size 2\n"
//       "\n"
//       " *P(Asia):*\n\n"
//       "|Asia|value|\n"
//       "|:-:|:-:|\n"
