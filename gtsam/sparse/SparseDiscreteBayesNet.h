 ...
 * @ingroup discrete
 */
class GTSAM_EXPORT SparseDiscreteBayesNet: public BayesNet<SparseDiscreteConditional> {
 public:
    typedef BayesNet<SparseDiscreteConditional> Base;
    typedef SparseDiscreteBayesNet This;
    typedef SparseDiscreteConditional ConditionalType;
    ...
    SparseDiscreteBayesNet() {}

    /** Construct from iterator over conditionals */
    template <typename ITERATOR>
    SparseDiscreteBayesNet(ITERATOR firstConditional, ITERATOR lastConditional)
        : Base(firstConditional, lastConditional) {}

    /** Construct from container of factors (shared_ptr or plain objects) */
    template <class CONTAINER>
    explicit SparseDiscreteBayesNet(const CONTAINER& conditionals)
        : Base(conditionals) {}

    /** Implicit copy/downcast constructor to override explicit template
     * container constructor */
    template <class DERIVEDCONDITIONAL>
    SparseDiscreteBayesNet(const FactorGraph<DERIVEDCONDITIONAL>& graph)
        : Base(graph) {}
    ...
    /** Add a SparseDiscreteDistribution using a table or a string */
    void add(const DiscreteKey& key, const std::string& spec) {
      emplace_shared<SparseDiscreteDistribution>(key, spec);
    }

    /** Add a DiscreteCondtional */
    template <typename... Args>
    void add(Args&&... args) {
      emplace_shared<SparseDiscreteConditional>(std::forward<Args>(args)...);
    }
...
// traits
template<> struct traits<SparseDiscreteBayesNet> : public Testable<SparseDiscreteBayesNet> {};
